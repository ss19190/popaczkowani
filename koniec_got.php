...
<body>
  ...
  <div class="content fade">
      ...
      $paczek = $_SESSION["idpaczka"];
          
      $cena;
          $rodzaj;
          
          
          $sql = "SELECT `gotowe_paczki`.`Rodzaj_paczka`, `gotowe_paczki`.`Cena`
            FROM `gotowe_paczki`
            WHERE `gotowe_paczki`.`ID` = '$paczek';";
      ...
      $zapytanie = "INSERT INTO zamowienia(IDKlienta, IDPiekarni, IDPaczka_got, Ilosc, Data_zamowienia, Godz_zamowienia, Koszt) VALUES ('$klient', '$piekarnia', '$paczek', '$ilosc', '$data', '$czas', '$koszt')";
      ...
      mysqli_query($link, $zapytanie);
        ...
        if ($result->num_rows > 0) {
          ...
          echo "<p>Rodzaj: ".$rodzaj."</p>";
          echo "<p>Cena za pączka: ".$cena."</p>";
