...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="dabrowa.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Dąbrowie Górniczej.</p>
       <p>Pusta ramka oznacza brak wybranego pączka</p>
       
       <form action="" method="post">
           
           <p><input type="date" name="pick_date"></p>
           <p><button type="submit" name="submit">Pokaż zamówienia</button></p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '2' AND zamowienia.Data_zamowienia = '$data';";
