...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="sosnowiec.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Sosnowcu.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '1' AND zamowienia.Data_zamowienia = '$data';";
