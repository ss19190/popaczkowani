...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="myslowice.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Mysłowicach.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '5' AND zamowienia.Data_zamowienia = '$data';";
