...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="czestochowa.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Częstochowie.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '6' AND zamowienia.Data_zamowienia = '$data';";
