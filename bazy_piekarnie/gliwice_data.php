...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="gliwice.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Gliwicach.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '7' AND zamowienia.Data_zamowienia = '$data';";
