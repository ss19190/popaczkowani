...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="grodziec.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Grodźcu.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '3' AND zamowienia.Data_zamowienia = '$data';";
