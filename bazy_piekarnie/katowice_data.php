...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="katowice.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Katowicach.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '4' AND zamowienia.Data_zamowienia = '$data';";
