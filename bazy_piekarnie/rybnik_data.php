...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="rybnik.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Rybniku.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '9' AND zamowienia.Data_zamowienia = '$data';";
