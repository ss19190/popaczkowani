...
<body>
  ...
  <div class="content fade">
   ...
   <div class="lewy fade">
       ...
       <p>Kliknij <a href="zabrze.php" target="_self">tutaj</a> aby zobaczyć wszystkie zamówienia w Zabrzu.</p>
...
if ($link -> connect_errno) {
  ...
  exit();
        ...
        WHERE `zamowienia`.`IDPiekarni` = '8' AND zamowienia.Data_zamowienia = '$data';";
